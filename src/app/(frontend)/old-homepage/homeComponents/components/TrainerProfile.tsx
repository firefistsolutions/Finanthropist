            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {profile?.achievements?.slice(0, 3).map((achievement, index) => {
                  ...
                  const icons = [
                    <svg key="check" className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>,
                    <svg key="growth" className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                    </svg>,
                    <svg key="education" className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
